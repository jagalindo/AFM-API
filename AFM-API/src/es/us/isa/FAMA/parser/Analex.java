...
tryAgain:
			...
			if ((LA(1)=='\r') && (_tokenSet_0.member(LA(2)))) {
				...
				do {
					if ((LA(1)=='\r') && (_tokenSet_0.member(LA(2)))) {
						...
						if ( _cnt2434>=1 ) { break _loop2434; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
					}
	...
	public final void mNUMERO(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		boolean synPredMatched2449 = false;
		if ((((LA(1) >= '0' && LA(1) <= '9')) && (_tokenSet_3.member(LA(2))))) {
			int _m2449 = mark();
			synPredMatched2449 = true;
			inputState.guessing++;
			try {
				{
				{
				...
				do {
					if (((LA(1) >= '0' && LA(1) <= '9'))) {
						...
						if ( _cnt2448>=1 ) { break _loop2448; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
					}
				...
				synPredMatched2449 = false;
			}
			rewind(_m2449);
inputState.guessing--;
		}
		if ( synPredMatched2449 ) {
			{
			int _cnt2451=0;
			_loop2451:
			do {
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					if ( _cnt2451>=1 ) { break _loop2451; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
			...
			do {
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					if ( _cnt2453>=1 ) { break _loop2453; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
			...
			boolean synPredMatched2457 = false;
			if ((((LA(1) >= '0' && LA(1) <= '9')) && (true))) {
				int _m2457 = mark();
				synPredMatched2457 = true;
				inputState.guessing++;
				try {
					{
					{
					...
					do {
						if (((LA(1) >= '0' && LA(1) <= '9'))) {
							...
							if ( _cnt2456>=1 ) { break _loop2456; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
						}
					...
					synPredMatched2457 = false;
				}
				rewind(_m2457);
inputState.guessing--;
			}
			if ( synPredMatched2457 ) {
				{
				int _cnt2459=0;
				_loop2459:
				do {
					if (((LA(1) >= '0' && LA(1) <= '9'))) {
						...
						if ( _cnt2459>=1 ) { break _loop2459; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
					}
